...
function Empty({ msg }) {
  return (
    <div className="border border-dashed border-border p-12 text-center rounded-sm bg-card" data-testid="empty-state">
...
function DashboardView() {
  ...
  return (
    <div className="space-y-6" data-testid="view-dashboard">
...
const titleFor = (path) => {
  ...
  if (path.startsWith("/search-terms")) return { t: "Search Terms", s: "detección de negativas" };
      ...
      <div className="p-5">
        <Routes>
          ...
          <Route
            path="/campaigns"
            element={
              active ? <CampaignsTable datasetId={active.id} /> : <Empty msg="Importa un CSV para ver campañas." />
            }
          />
          <Route
            path="/search-terms"
            element={
              active ? <SearchTermsTable datasetId={active.id} /> : <Empty msg="Importa un CSV para ver search terms." />
            }
          />
          <Route
            path="/ai"
            element={
              active ? <AiPanel datasetId={active.id} initialRecs={active.ai_recommendations} /> : <Empty msg="Importa un CSV para generar recomendaciones." />
            }
          />
